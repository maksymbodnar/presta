<?php /* Smarty version Smarty-3.1.19, created on 2017-10-04 05:45:29
         compiled from "/vagrant/presto/admin1795k6wof/themes/default/template/controllers/shop/helpers/list/list_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:40342968959d47579042059-69848078%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4f8d3798512ccc941540e2eb0a2fc7898ca60797' => 
    array (
      0 => '/vagrant/presto/admin1795k6wof/themes/default/template/controllers/shop/helpers/list/list_content.tpl',
      1 => 1503382292,
      2 => 'file',
    ),
    '2e68d6704d9070a121e93c5e243035b7fdd5aad9' => 
    array (
      0 => '/vagrant/presto/admin1795k6wof/themes/default/template/helpers/list/list_content.tpl',
      1 => 1503382293,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '40342968959d47579042059-69848078',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59d4757914b7e5_53477209',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59d4757914b7e5_53477209')) {function content_59d4757914b7e5_53477209($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/vagrant/presto/vendor/prestashop/smarty/plugins/function.counter.php';
?>
...
<?php }?>">
	<?php } else { ?>
		<td class="pointer" onclick="document.location = '<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['current_index']->value,'html','UTF-8');?>
&amp;shop_id=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['identifier']->value],'html','UTF-8');?>
...
" onmouseover="$(this).css('text-decoration', 'underline')" onmouseout="$(this).css('text-decoration', 'none')" class="_blank"><?php echo $_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value];?>
		...
		<?php } else { ?>
			<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminShopUrl'),'html','UTF-8');?>
&amp;shop_id=<?php echo intval($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['identifier']->value]);?>
&amp;addshop_url" class="multishop_warning"><?php echo smartyTranslate(array('s'=>'Click here to set a URL for this shop.','d'=>'Admin.Shopparameters.Notification'),$_smarty_tpl);?>
</a>
		<?php }?>
	<?php } else { ?>
